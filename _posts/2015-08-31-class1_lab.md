...
The description should be uploaded to the /students/RPI/2015 directory.  You will find in here a basic template called `blank_student.yaml.  [Yaml](http://yaml.org) is an human readable way of storing and encoding data that is increasingly used by websites and other programs.  
