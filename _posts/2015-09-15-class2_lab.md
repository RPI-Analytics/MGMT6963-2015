...
#Question: can you do math on vectors?  Try the following. What happens and why?
...
#### R List
A list is a array containing other R objects.  While we won't use it very frequently, it is a flexible data structure will contain the output of another analyses.  
...
#Question: Is there a difference between the data stored via the alldata and the alldata2 array?   

#Question: Is there a difference with the somedata versions of ages/grades and the all data version of ages/grades?
...
We can use the python API helper to see what methods are available. 
