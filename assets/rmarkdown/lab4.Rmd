...
1. Subset only the *survived*, *sex*, and *age* columns and create a new dataframe with the results.

2. Drop the *ticket* and the cabin and create a new dataframe with the results.

3. Split the dataset into a *train* dataframe having the first 80% of the records and a *test* dataframe having the last 20%. 

4. Randomely sample the dataset so that there are 2 samples.

5. Create one dataframe with all of the *males* and a second with all of the *females*. 
