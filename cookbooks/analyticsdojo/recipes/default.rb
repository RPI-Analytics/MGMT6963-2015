...
dependencies = [
  ...
  "build-essential", "r-base", "gdebi-core", "libapparmor1",
]
...
package 'rstudio' do
  ...
  source '/vagrant/cookbooks/analyticsdojo/files/rstudio-server-0.99.467-i386.deb'
  action :install
end
...
execute "install_requirements" do
  command "pip install -r /vagrant/cookbooks/analyticsdojo/recipes/analyticsdojo-requirements.txt --allow-unverified matplotlib --allow-all-external"
  # action :nothing
end
